...
def Q(xzt):
    """
    Q(x,z,t) = pi cos(2 pi x) sin(4 pi z) exp(-4 pi^2 v_h t)
    """
    x, z, t = unpack(xzt)
...
def benchmark_solution(xzt):
    ...
    p(x,z,t) = 1/4 cos(4 pi x) exp(-8 pi^2 v_h t) + cos(2 pi z)/(2 pi)
    T(x,z,t) = sin(2 pi z)
    """
    x, z, t = unpack(xzt)
